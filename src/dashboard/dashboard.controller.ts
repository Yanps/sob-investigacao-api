...
export class DashboardController {
   ...
   * Retorna o mesmo formato esperado pelo frontend dashboard-analise-sob (averageTimes, swearWords, giveupWords, phaseMessages, aiAnalysis).
   */
  @Get()
  async getDashboard(
    ...
    // Exclui fase "Geral" para alinhar ao dashboard de referência (apenas Fase 1, Fase 2, etc.)
